...
// the full reasoning (same fix, same measured cause: this page and
// /careers had the identical live-Supabase-round-trip-per-navigation
// issue). getBlogPosts's own createBlogPost/updateBlogPost/
// deleteBlogPost (lib/mutations.ts) already call revalidatePath("/blog").
